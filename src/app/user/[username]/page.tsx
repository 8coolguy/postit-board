...
export default function Home({params}){
    ...
    return (
        <div>
            ...
            <div className="z-3 absolute bottom-[100px] left-[100px]">
                <Button variant="outline" size="icon-lg" className="rounded-full" onClick={handleAddPost}>
                    <i className="ri-add-large-line"></i>
                </Button>
            </div>
            <div className="z-3 absolute bottom-[100px] right-[100px]">
                <Button variant="outline" size="icon-lg" className="rounded-full" onClick={handleOpenSettings}>
                    <i className="ri-settings-3-line"></i>
                </Button>
            </div>
            <ModalComponent isOpen={settingIsOpen}/>
        </div>
    )
} 
